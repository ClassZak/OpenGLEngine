#include "../../include/CustomShapes/Jelly.hpp"
#include <stdlib.h>
...
void Jelly::Init(const std::string& shaderName)
{
	...
	auto renderer_shader = Zak::AssetsManager::GetInstance().GetShader(shaderName);
